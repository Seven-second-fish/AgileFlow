...
mustInclude('QUICKSTART.md', '## 高级使用');
mustInclude('QUICKSTART.md', '普通用户不需要');
mustInclude('TROUBLESHOOTING.md', '## 现在谁需要行动？');
mustInclude('examples/flow-interaction.md', '## 完整实录：从一句话到可交付结果');
mustInclude('examples/flow-interaction.md', '### 5. 验收与交付');
